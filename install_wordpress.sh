...
#on cree un rep pour faire deploiement pour tt les fichiers sont tous dans le meme endroit
prepare_wordpress(){
...
#tt se cree on le rep wordpress  qu'on a deja cree
create_pv(){
...
spec:
  ...
  nfs:
  #persistant volume qui va connecte sur le serveur nfs
    server: '${IP_NFS}'
